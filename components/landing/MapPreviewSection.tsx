            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                        Temukan berbagai lokasi penting di Desa Kemasan melalui peta interaktif di bawah ini.
                    </p>
                </motion.div>
                    ...
                    <div className="rounded-3xl overflow-hidden shadow-2xl border border-border bg-card isolate">
                        ...
                        <div className="p-6 flex flex-col sm:flex-row items-center justify-between gap-4 bg-card">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="font-semibold text-lg">Peta Desa Kemasan</h3>
                                </div>
                            </div>
                            ...
                            <Button
                                asChild
                                size="lg"
                                className="group bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 shadow-lg shadow-pink-500/25 hover:shadow-pink-500/40 transition-all duration-300"
                            >
                                <Link href="/peta">
