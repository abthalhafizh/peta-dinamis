                    ...
                    <div className="flex items-center justify-between h-16 md:h-20">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            ...
                            >
                                <Button
                                    asChild
                                    className="bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 shadow-lg shadow-pink-500/25 transition-all duration-300 hover:shadow-pink-500/40"
                                >
                                    <Link href="/peta">
                    ...
                    >
                        <div className="bg-background/95 backdrop-blur-xl border-b border-border shadow-xl">
                            <div className="px-4 py-6 space-y-4">
                                ...
                                <Button
                                    asChild
                                    className="w-full bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 shadow-lg"
                                >
                                    <Link href="/peta">
                                        <MapPin className="w-4 h-4 mr-2" />
                                        Lihat Peta
