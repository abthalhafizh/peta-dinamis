                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h3 className="text-xl font-bold">Desa Kemasan</h3>
                                <p className="text-sm text-muted-foreground">Krian, Sidoarjo, Jawa Timur</p>
                            </div>
                        </div>
                        <p className="text-muted-foreground mb-6 max-w-md">
                            Sistem Informasi Geografis Desa Kemasan menyediakan peta interaktif
                            untuk mempermudah warga dan pengunjung menjelajahi wilayah desa.
                        </p>
                        <div className="flex gap-4">
                            <a
                                href="#"
                                className="w-10 h-10 rounded-full bg-muted hover:bg-pink-500 flex items-center justify-center transition-colors group"
                            >
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a href="#beranda" className="text-muted-foreground hover:text-pink-600 transition-colors">
                                    Beranda
                                </a>
                            </li>
                            <li>
                                <a href="#tentang" className="text-muted-foreground hover:text-pink-600 transition-colors">
                                    Tentang Kami
                                </a>
                            </li>
                            <li>
                                <a href="#fitur" className="text-muted-foreground hover:text-pink-600 transition-colors">
                                    Fitur
                                </a>
                            </li>
                            <li>
                                <Link href="/peta" className="text-muted-foreground hover:text-pink-600 transition-colors">
                                    Peta Interaktif
                                </Link>
                            </li>
                        </ul>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="text-muted-foreground">
                                    Desa Kemasan, Kec. Krian, Kab. Sidoarjo, Jawa Timur
                                </span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Phone className="w-5 h-5 text-pink-600 shrink-0" />
                                <span className="text-muted-foreground">081331248648</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Mail className="w-5 h-5 text-pink-600 shrink-0" />
                                <span className="text-muted-foreground">abthalhafizh@gmail.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="pt-8 border-t border-border">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-sm text-muted-foreground">
                            © {currentYear} Desa Kemasan. Hak Cipta Dilindungi.
                        </p>
